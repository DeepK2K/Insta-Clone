...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        //upload the image to the firebase storage with a post id
        //get the download url from the firebase storage and update th original post with image
        ...
        <Transition.Root show={open} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto"
                ...
                <div className='flex items-end justify-center min-h-[800px]
                    ...
                    {/* This element is to trick the browser into centering the content */}
                        ...
                        sm:max-w-sm sm:w-full sm:p-6 '>
                            <div>
                                {selectedFile ? (
                                    ...
                                    <div className='mx-auto flex rounded-full items-center justify-center h-12 w-12
                                ...
                                <div className='mt-5 sm:mt-6'>
                                    ...
                                    px-4 py-2 text-base bg-red-600 font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2
